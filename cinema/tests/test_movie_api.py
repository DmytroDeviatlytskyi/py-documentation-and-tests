...
class PrivateMovieApiTests(TestCase):
    ...
    def test_filter_movie_by_genres(self):
        ...
        movie_with_genre_1 = sample_movie(title="test_title_1")
        movie_with_genre_2 = sample_movie(title="test_title_2")
    ...
    def test_filter_movie_by_actors(self):
        ...
        movie_with_actor_1 = sample_movie(title="test_title_1")
        movie_with_actor_2 = sample_movie(title="test_title_2")
    ...
    def test_filter_movie_by_title(self):
        movie_1 = sample_movie(title="Test Title 1")
        movie_2 = sample_movie(title="Test Title 2")

        res = self.client.get(
            MOVIE_URL, {"title": "Test Title 1"}
        )
